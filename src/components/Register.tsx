      ...
      <div className="flex h-screen">
        <div className="m-auto">
          <div>
            ...
            <form className="md:w-[600px] p-0" onSubmit={handleSubmit(submitForm)}>
            <button
              type="button"
              className="relative w-full flex justify-center items-center px-5 py-2.5 font-medium tracking-wide text-white capitalize bg-green-500 rounded-md hover:bg-green-700 focus:outline-none transition duration-300 transform active:scale-95 ease-in-out"
            >
              <svg
