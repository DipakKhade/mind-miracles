...
export const PayAndRegisterButton = ({ name, email, whatsapp, age }: {
    name: string,
    email: string,
    whatsapp: number,
    age: number
    ...
    return <>
        ...
        />
        <Button disabled={!name || !email} onClick={createOrder} type="submit" className="w-full bg-green-700 hover:bg-[#3a5a40]">
            {loading ?
                <Spinner/>
                : "Pay And Register"}
