      ...
      <nav>
        <div className="relative flex max-w-screen-xl flex-col px-4 py-4 md:mx-auto md:flex-row md:items-center">
          ...
          <nav
            ...
            className="flex max-h-0 w-full flex-col items-center justify-between transition-all peer-checked:mt-8 peer-checked:max-h-56 md:ml-24 md:max-h-full md:flex-row md:items-start overflow-hidden"
          >
